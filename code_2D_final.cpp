//solving 2D polluted jet in larminar cross flow channal 
#include <iostream>
#include <cmath>
#include <fstream>
#include <stdlib.h>
...
//step 2 find P[i,j] : solving Poison equation using gauss seidel iteration
...
//step3 find uv using pressure value from step 2
...
//find passive scalar using explicit eulet
